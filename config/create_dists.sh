...
# realdev
replaceProperty 'dist-realdev' 's/"API_ENDPOINT"/"https:\/\/api\.dev\.crisiscleanup\.services"/g'
replaceProperty 'dist-realdev' 's/"API_PHONE_ENDPOINT"/"https:\/\/api\.dev\.crisiscleanup\.services"/g'
replaceProperty 'dist-realdev' 's/"GOOGLE_MAPS_API_KEY"/"AIzaSyAS7GowniFU4IZMZUEw0rVPyzY1EcWGXNU"/g'

# realstaging
replaceProperty 'dist-realstaging' 's/"API_ENDPOINT"/"https:\/\/api\.staging\.crisiscleanup\.services"/g'
replaceProperty 'dist-realstaging' 's/"API_PHONE_ENDPOINT"/"https:\/\/api\.staging\.crisiscleanup\.services"/g'
replaceProperty 'dist-realstaging' 's/"GOOGLE_MAPS_API_KEY"/"AIzaSyAS7GowniFU4IZMZUEw0rVPyzY1EcWGXNU"/g'

# realprod
replaceProperty 'dist-realprod' 's/"API_ENDPOINT"/"https:\/\/api\.prod\.crisiscleanup\.services"/g'
replaceProperty 'dist-realprod' 's/"API_PHONE_ENDPOINT"/"https:\/\/api\.prod\.crisiscleanup\.services"/g'
