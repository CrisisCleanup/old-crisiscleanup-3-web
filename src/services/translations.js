const messages = {
  "en": {
    ...
    "events": {
      ...
      "chat_description": "Communicating in the chat feature earns points."
      "ask_question_description": "Earn points for asking questions. Your questions help others."
      "invite_user_description": "Inviting users to join your organization."
      "invited_user_activate_description": "A user you invited activates their account."
      "answer_test_question_description": "You get credit for answering a test question (whether or not you got it right)."
      "finish_test_description": "You get points for finishing a test."
      "view_case_description": "You get credit for viewing a case."
      "add_case_description": "Earn points every time you add a case."
      "update_case_description": "Earn credit every time you update a case."
      "close_case_description": "Marking a case closed is worth lots of points."
      "vote_description": "Get points when you vote content up or down."
      "get_voted_up_description": "You get points if others like your content."
      "get_voted_down_description": "You lose points if others don't like your content."
      "upload_layer_description": "Uploading a map layer earns points."
      "update_org_profile_description": "Update your organization profile to earn points."
      "invite_affiliate_description": "You get credit for inviting organizations to affiliate with your organization."
      "approve_affiliate_description": "You get points for accepting an invitation to affiliate with another organization."
      "join_group_description": "You get credit if you join your organization to a group, making it easier to collaborate."
      "update_user_profile_description": "Updating your personal profile helps us keep in contact and earns you points."
      "inbound_call_description": "You get credit for each inbound phone call you take."
      "outbound_call_description": "You get credit for each outbound phone call you make."
      ...
      "claim_case_description": "You get credit each time you claim a case."
      "unclaim_case_description": "Unclaiming a case is a great thing to allow others to help. You get credit for it."
      "register_equipment_description": "Registering equipment earns points because it can help increase the value of your hours."
      "upload_photo_description": "You get credit for uploading photos, which are worth a thousand words each."
      "view_page_description": "We give you credit for exploring Crisis Cleanup."
      "install_app_description": "Installing the app will give you more credit"
      "read_notification_description": "Every time you read a notification, we reward you."
      "submit_translation_description": "If you fix one of our translations, we'll give you credit for it."
      "translation_accepted_description": "If we accept one of your translation fixes, you get points."
      "translation_rejected_description": "Unfortunately, bad translations don't earn any points."
      "request_case": "Request a Case"
      "request_case_description": "Requesting a case is the polite thing to do. You earn credit."
      "approve_case_transfer": "Approve a Case Transfer"
      "approve_case_transfer_description": "You get credit for politely allowing other organizations to take a case you aren't going to assist."
      "manage_user": "Manager a User"
      "manage_team": "Manage a Team"
      "manage_user_description": "You get points for updating or managing users in your organization."
      "manage_team_description": "You get points for updating or managing teams in your organization."
    }
  },
  "es": {
    "unitTest": {
    ...
    "events": {
      ...
      "submit_translation": "Presentar una traducción"
      ...
      "chat_description": "La comunicación en la función de chat gana puntos."
      "ask_question_description": "Ganar puntos por hacer preguntas. Sus preguntas ayudan a los demás."
      "invite_user_description": "Invitando a los usuarios a unirse a su organización."
      "invited_user_activate_description": "Un usuario invitado que activa su cuenta."
      "answer_test_question_description": "Se obtiene crédito para responder a una pregunta de la prueba (si o no lo ha hecho bien)."
      "finish_test_description": "Se consiguen puntos por terminar una prueba."
      "view_case_description": "Se obtiene el crédito para la visualización de un caso."
      "add_case_description": "Gane puntos cada vez que añada un caso."
      "update_case_description": "Obtener crédito cada vez que se actualiza un caso."
      "close_case_description": "Marcando un caso cerrado es digno de una gran cantidad de puntos."
      "vote_description": "Obtener puntos al momento de votar el contenido arriba o hacia abajo."
      "get_voted_up_description": "Se consiguen puntos si otros como su contenido."
      "get_voted_down_description": "Se pierde puntos si otros no les gusta su contenido."
      "upload_layer_description": "Carga de una capa de mapa gana puntos."
      "update_org_profile_description": "Actualizar su perfil de organización para ganar puntos."
      "invite_affiliate_description": "Se obtiene crédito para invitar a las organizaciones de afiliarse a su organización."
      "approve_affiliate_description": "Se consiguen puntos por aceptar una invitación a afiliarse a otra organización."
      "join_group_description": "Se obtiene de crédito si se une a su organización a un grupo, por lo que es fácil colaborar."
      "update_user_profile_description": "La actualización de su perfil personal nos ayuda a mantener en contacto y le hace ganar puntos."
      "inbound_call_description": "Se obtiene crédito por cada llamada telefónica entrante se toma."
      "outbound_call_description": "Se obtiene crédito por cada teléfono de llamadas salientes que realice."
      ...
      "claim_case_description": "Se obtiene de crédito cada vez que reclame un caso."
      "unclaim_case_description": "Unclaiming un caso es una gran cosa para permitir que otros le ayuden. Se obtiene crédito por ello."
      "register_equipment_description": "El registro de los equipos gana puntos, ya que puede ayudar a aumentar el valor de sus horas."
      "upload_photo_description": "Se obtiene crédito para subir fotos, que valen más que mil palabras cada uno."
      "view_page_description": "Le damos el crédito para la exploración de limpieza de crisis."
      "install_app_description": "Instalación de la aplicación le dará más crédito"
      "read_notification_description": "Cada vez que se lee una notificación, que se lo pague."
      "submit_translation_description": "Si se fija una de nuestras traducciones, le daremos crédito por ello."
      "translation_accepted_description": "Si aceptamos una de sus correcciones de traducción, la obtención de puntos."
      "translation_rejected_description": "Por desgracia, las malas traducciones no ganan ningún punto."
      "request_case": "Caso de solicitar una"
      "request_case_description": "Solicitud de un caso es la cosa educada a hacer. A obtener crédito."
      "approve_case_transfer": "Aprobar una caja de transferencia"
      "approve_case_transfer_description": "Se obtiene crédito para permitir que otras organizaciones cortésmente a tomar un caso que no van a asistir."
      "manage_user": "Director de un usuario"
      "manage_team": "Gestionar un equipo"
      "manage_user_description": "La obtención de puntos para la actualización o la gestión de usuarios de la organización."
      "manage_team_description": "Se consiguen puntos por la actualización o la gestión de equipos en su organización."
    }
  },
  "cs": {
    "unitTest": {
    ...
    "events": {
      ...
      "submit_translation": "Pošlete Překlad"
      "translation_accepted": "překlad Accepted"
      "translation_rejected": "překlad Odmítnuto"
      "login_description": "Přihlášení na webové stránky nebo app."
      "one_minute_description": "Dostanete body za dobu přihlášeni."
      "chat_description": "Komunikaci v chatu získává body."
      "ask_question_description": "Získávat body za kladení otázek. Vaše dotazy pomáhat druhým."
      "invite_user_description": "Pozvání uživatelů o připojení k vaší organizaci."
      "invited_user_activate_description": "Uživatel vás pozval aktivuje svůj účet."
      "answer_test_question_description": "Dostanete úvěr pro zodpovězení testovací otázku (zda je či není to máš pravdu)."
      "finish_test_description": "Dostanete body za dokončení testu."
      "view_case_description": "Dostanete úvěr pro sledování případu."
      "add_case_description": "Získávat body pokaždé, když přidáte případ."
      "update_case_description": "Vydělat kreditu pokaždé, když aktualizovat případ."
      "close_case_description": "Značení případ uzavřen, je stojí spoustu bodů."
      "vote_description": "Získat body, když budete volit obsah nahoru nebo dolů."
      "get_voted_up_description": "Získáte bodů, pokud jiní jako váš obsah."
      "get_voted_down_description": "Ztratíte body, pokud ostatní nemají rádi svůj obsah."
      "upload_layer_description": "Nahrání mapovou vrstvu získává body."
      "update_org_profile_description": "Aktualizujte svůj profil organizace získávat body."
      "invite_affiliate_description": "Dostanete ocenění za pozvání organizace pobočky s vaší organizaci."
      "approve_affiliate_description": "Dostanete body za přijetí pozvání do pobočky s jinou organizací."
      "join_group_description": "Dostanete úvěr, pokud jste se připojili k vaší organizaci skupiny, což usnadňuje spolupráci."
      "update_user_profile_description": "Aktualizace svůj osobní profil nám pomáhá zůstat v kontaktu a vydělá vám body."
      "inbound_call_description": "Dostanete ocenění za každou příchozí telefonát užíváte."
      "outbound_call_description": "Dostanete úvěr pro každou odchozí telefonát uděláte."
      ...
      "claim_case_description": "Dostanete úvěr pokaždé, když tvrdí, případ."
      "unclaim_case_description": "Zrušení přiřazení případu je skvělá věc, aby ostatní, aby pomohli. Dostanete ocenění za to."
      "register_equipment_description": "Evidenční zařízení získává body, protože to může pomoci zvýšit hodnotu vašich hodin."
      "upload_photo_description": "Dostanete úvěr pro nahrávání fotografií, které stojí za tisíc slov každý."
      "view_page_description": "Dáváme vám úvěr pro objevování krize Vyčištění."
      "install_app_description": "Instalace aplikace vám dá více kreditu"
      "read_notification_description": "Pokaždé, když budete číst oznámení, vám odmění."
      "submit_translation_description": "Máte-li opravit jeden z našich překladů, dáme vám kredit za to."
      "translation_accepted_description": "Přijmeme-li jeden z vašich překladů oprav, dostanete body."
      "translation_rejected_description": "Bohužel, špatné překlady nevydělávají žádné body."
      "request_case": "Požádat o Case"
      "request_case_description": "Požadující případ je zdvořilý, co dělat. Získáte kredit."
      "approve_case_transfer": "Schválit případě předání"
      "approve_case_transfer_description": "Dostanete ocenění za slušně umožnění dalších organizací, aby se případ nebudete pomáhat."
      "manage_user": "Manažer Uživatel"
      "manage_team": "Správa tým"
      "manage_user_description": "Dostanete body za aktualizaci nebo správu uživatelů ve vaší organizaci."
      "manage_team_description": "Dostanete body za aktualizaci nebo správu týmů ve vaší organizaci."
    }
  }
}
