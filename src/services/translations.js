const messages = {
  en: {
    ...
    forms: {
      preamble_default_1: "Enter property damage and needs.",
      preamble_default_2: "No sensitive information!",
      preamble_default_3: "Tell the client this information will be shared with many organizations to provide service as fast as possible, which may be several weeks. Service is not guaranteed.",
    ...
    phone_status: {
      ...
      technical_difficulty: "Techical difficulty"
    }
  },
  es: {
    publicHeader: {
    ...
    forms: {
      preamble_default_1: "Ingrese el dato y las necesidades de la propiedad.",
      preamble_default_2: "¡No hay información confidencial!",
      preamble_default_3: "Dígale al residente que esta información se compartirá con muchas organizaciones para brindar el servicio lo más rápido posible, lo que puede tardar varias semanas. El servicio no está garantizado.",
      property_info: "Propiedad e información personal",
      name: "Nombre del Residente",
      do_not_work_before: "No trabaje antes de esta fecha",
      address: "Calle y Número",
      city: "Ciudad",
      ...
      wind_info_end: "[Fin del viento]",
      tree_info_end: "[Árboles finales]",
      work_info_end: "[Fin Trabajo]",
      hazards_info: "Peligros",
      habitable: "Es el hogar habitable",
      electricity: "Dispone de energía eléctrica",
      ...
      other_hazards: "Otros peligros",
      hazards_info_end: "[Fin de los peligros]",
      claim_status_report_info: "Estado e informe",
      ...
      damage_fencing: "Daño a la esgrima",
      ...
      damage_windows: "Daño a Windows",
      damage_yard: "Daño a la yarda",
      damaged_fence_length: "Longitud dañada de la cerca",
      ...
      doors_status: "Estado",
      doors_waiver_signed: "Exención de las puertas firmada",
      ...
      fence_notes: "Notas de valla",
      fence_type: "Tipo de valla",
      ...
      hvac_waiver_signed: "HVAC Renuncia Firmada",
      ...
      known_asbestos: "Asbesto conocido",
      known_lead_paint: "Pintura de plomo conocida",
      leaking: "Fuga",
      livestock_missing: "Falta de ganado",
      ...
      mold_drying: "Se necesita secado",
      mold_hvac: "HVAC",
      mold_replace_studs: "Mold Reemplace Studs",
      mold_sanitation_complete: "Higiene del molde completa",
      ...
      roof_collapse: "Colapsar el tejado",
      ...
      roof_gutters_shingles: "Herpes",
      roof_gutters_status: "Estado",
      roof_gutters_tarping: "Tarpado",
      ...
      tracking_num: "Seguimiento de Num",
      tree_debris: "Restos de árboles",
      uninhabitable: "Inhabitable",
      unrestrained_animals: "Animales desenfrenados",
      unsalvageable_structure: "Estructura inalcanzable",
      walkway_clearing: "Calzada de la calzada",
      ...
      water_delivered_date: "Fecha de entrega de agua",
      water_delivered: "Agua entregada",
      water_shutoff_location: "Lugar de cierre de agua",
      water_source: "Fuente de agua",
      water_status: "Dispone del servicio de agua",
      ...
      fencing_info: "Esgrima",
      fencing_info_end: "[Final de esgrima]",
      ash_sifting_info: "Ash Sifting",
      ash_sifting_info_end: "[Fin del tamizado de ceniza]",
      ...
      muck_out_info: "Muck Out",
      muck_out_info_end: "[Fin Muck Out]",
      mold_remediation_info: "Remediación de moho",
      mold_remediation_info_end: "[Remediación del molde final]",
      ...
      yard_debris: "Desechos de la cuadra",
      ...
      feeding_unit_info_end: "[Unidad de alimentación final]",
      ...
      retardant_clean_vehicle: "Retardante en Vechicle",
      retardant_material_wood: "Retardante en madera",
      ...
      fence_info: "Vallar Daño y Necesidades",
      ...
      veteran: "Veterano",
      well_head_replacement: "Sustitución de la cabeza del pozo",
      possible_asbestos: "Posible asbesto",
      ash_smoke_fire_info: "Ceniza, humo, trabajo de fuego",
      ash_smoke_fire_info_end: "[Fin ceniza, humo, trabajo de fuego]",
      tile_removal: "Azulejo",
      utilities_info: "Utilidades",
      utilities_info_end: "[Utilidades de finalización]",
      ...
      structural_problems_info_end: "[Fin problemas estructurales]",
      ...
      clothing_count: "Artículos de ropa",
      basic_needs_details: "Solicitud de necesidad específica",
      basic_needs_info_end: "[Fin Víveres]",
      spiritual_emotional_psychological_care: "¿Nota usted cambios en el comportamiento habitual de alguno de sus familiares? Alteraciones en el apetito, sueño, cambio de estado de ánimo.",
      case_work_priorities_info: "Talleres y Capacitaciones",
      ...
      case_work_priorities_info_end: "[Fin Talleres y Capacitaciones]",
      food_meals_daily_count: "Comidas requeridas al día",
      food_meals_type: "Define que alimentos te hacen falta",
      ...
      well_cap_replacement: "Reemplazo del casquillo del pozo",
      total_residents_count: "¿Cuántas personas habitan este hogar?",
      rebuild_adobe: "Construcción adobe",
      rebuild_bajereque: "Construcción bajereque",
      rebuild_hollow_block: "Construcción block hueco",
      rebuild_block: "Construcción block",
      ...
      phone1_help: "Se requiere al menos un número de teléfono. Llama antes de ayudar.",
      residence_type_help: "Una persona desplazada de su hogar primario, o que vive en malas condiciones en su hogar principal, a menudo son prioridades más altas para las organizaciones de socorro.",
      work_type_help: "Elige el ícono que aparece en el mapa. Si hay más de un tipo, elija el tipo que sea más importante.",
      ...
      special_needs_help: "Solo incluya necesidades especiales que estén directamente relacionadas con el servicio, p. 'Esta en silla de ruedas', o 'Tiene dificultad para oir, toque duro'.",
      ...
      flood_height_help: "Para 6 pulgadas, usa '0.5'",
      ...
      initials_of_resident_present_help: "Esto puede ayudar si hay alguna vez un malentendido sobre el trabajo realizado.",
      ...
      num_burned_trees_help: "Advertencia: los árboles quemados pueden ahuecarse o las cenizas pueden quemarse. Al cortar, los árboles quemados pueden caer en direcciones impredecibles.",
      ...
      case_work_priorities_info_help: "Enumera los siguientes temas del más útil (1) a menos útil (5)",
    ...
    phone_status: {
      ...
      thanked_us: "El cliente nos agradeció o nos dio su voluntario",
      wants_to_volunteer: "El cliente quiere ser voluntario: se le recomienda buscar localmente",
      other: "Otro - ver notas",
      mandarin: "El cliente habla MANDARIN y necesita una devolución de llamada",
      spanish: "El cliente habla ESPAÑOL y necesita una devolución de llamada",
      another_language: "El cliente habla otro idioma y necesita una devolución de llamada (idioma en las notas)",
      immediate_needs: "El cliente necesita ayuda inmediata. Seguí las instrucciones para escalar el caso.",
      special_needs: "El cliente necesita otra ayuda especial; ver notas",
      voicemail: "Correo de voz izquierdo",
      no_voicemail: "Sin mensaje de voz o sin configurar",
      second_call: "Segunda llamada",
      voicemail_full: "Correo de voz completo",
