const messages = {
  ...
  es: {
    publicHeader: {
      ...
      join: "Unase a nosotros",
      register: "Registro",
      login: "Iniciar sesión"
    },
    bannerCycler: {
      msg1: "Cada día, los voluntarios ahorran a los sobrevivientes del desastre mas de <strong style=\"color:white;\">$50,000</strong>. Tu podrías ser uno de ellos.",
    ...
    actions: {
      ...
      save_unclaim: "Guardar y no reclamar",
    ...
    formLabels: {
      preamble_default: "Ingrese el dato y las necesidades de la propiedad. <u>¡No hay información confidencial!</u> Dígale al residente que esta información se compartirá con muchas organizaciones para brindar el servicio lo más rápido posible, lo que puede tardar varias semanas. El servicio no está garantizado.",
