const messages = {
  "en": {
    ...
    "accessRules": {
      ...
      "coordination_access_org_role": "Full access for client data claimed or reported by affiliates. Redacted access to other survivors' information.",
      ...
      "ltr_access_org_role": "Full access for client data within a Long Term Recovery Group's jurisdiction (e.g. county or parish), or any claimed or reported cases. Redacted access to other survivors' information.",
      ...
      "preliminary_access_org_role": "Full access for an organizaton's client data, but extremely restricted access to all other data, until the organization is approved by a full administrator.",
      ...
      "public_access_org_role": "Access to de-identified public maps and data.",
      ...
      "recovery_access_org_role": "Complete access to client database and maps.",
      ...
      "situational_awareness_org_role": "Access to non-sensitive data in your jurisdiction, and de-identified information outside your jurisdiction.",
      ...
      "statistics_access_org_role": "Access to de-identified statistics and public information.",
  ...
  "es": {
    ...
    "accessRules": {
      ...
      "coordination_access_org_role": "El pleno acceso a los datos del cliente reclamado o reportados por los afiliados. el acceso a la información redactada otros sobrevivientes.",
      ...
      "ltr_access_org_role": "El pleno acceso a los datos del cliente dentro de la jurisdicción de un plazo de recuperación Grupo larga (por ejemplo, del condado o parroquia), o cualesquiera casos reclamados o denunciados. el acceso a la información redactada otros sobrevivientes.",
      ...
      "preliminary_access_org_role": "El pleno acceso a los datos de clientes de una Organizaton, pero el acceso muy restringido a todos los demás datos, hasta que la organización es aprobado por un administrador completo.",
      ...
      "public_access_org_role": "El acceso a des-identificarse mapas y datos públicos.",
      ...
      "recovery_access_org_role": "Termine el acceso a bases de datos y mapas del cliente.",
      ...
      "situational_awareness_org_role": "El acceso a los datos no sensibles en su jurisdicción, y la información no identificable fuera de su jurisdicción.",
      ...
      "statistics_access_org_role": "El acceso a las estadísticas y la información pública no identificada.",
