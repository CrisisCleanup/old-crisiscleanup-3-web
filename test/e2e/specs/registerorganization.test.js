...
module.exports = {
  '@tags': ['register-organization'],
  'Go to Register Organization': function (browser) {
    var registerorganization = browser.page.login();
  ...
  'login with creds': function (browser) {
    ...
    login
      //.waitForElementVisible('.vue-notification', 5000)
      //.assert.visible('.vue-notification')
